  ...
  try {
    const { output } = await generateText({
      ...
      system: [
        ...
        "This role is a technical builder inside eng orgs: Rules libraries, prompt architectures, MCP, dashboards, Cloud Agents, workflow guides.",
        "Credibility comes from shipping artifacts alongside teams, not from training decks or event production alone.",
        "Hackathon/event facilitation without reusable artifacts or measurement should not score as strong overall fit.",
        "Reward senior eng / DevEx backgrounds that show systems thinking, build-with enablement, and measurable habit change.",
        "Always return all six dimensions with the new ids from the rubric.",
        ...
        "When fit is strong or promising, include applying and the Cursteroids artifact challenge in nextSteps.",
        "When fit is stretch or unlikely, suggest concrete artifact-building experience to gain before applying.",
